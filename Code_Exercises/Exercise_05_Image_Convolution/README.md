...
For For DPC++:
```sh
dpcpp -fsycl -o sycl-ex-5 ../Code_Exercises/Exercise_05_Image_Convolution/source.cpp
```
...
./Code_Exercises/Exercise_05_Image_Convolution/exercise_01_compiling_with_sycl_source
```
