...
```sh
cd build/Code_Exercises/Exercise_16_Image_Convolution
```
and execute:
...
```sh
icpx -fsycl -o exercise_15_source -I../../Utilities/include/ -I../../External/stb ../Code_Exercises/Exercise_16_Image_Convolution/source.cpp
```
