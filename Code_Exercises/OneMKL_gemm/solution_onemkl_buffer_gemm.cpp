...
int main() {
  ...
  sycl::buffer<T, 1> a{A, sycl::range<1>{M*N}};
  sycl::buffer<T, 1> b{B, sycl::range<1>{N*P}};
  sycl::buffer<T, 1> c{C_host, sycl::range<1>{M*P}};

  // TODO: Use oneMKL GEMM USM API
  oneapi::mkl::transpose transA = oneapi::mkl::transpose::nontrans;
  oneapi::mkl::transpose transB = oneapi::mkl::transpose::nontrans;
  oneapi::mkl::blas::column_major::gemm(Q, transA, transB, n, m, k, alpha, b, ldB, a, ldA, beta, c, ldC);
  Q.wait();
